...
using OnlineBanking.Security.Settings;
using OnlineBanking.Security.UserTokenService.Interface;
...
namespace OnlineBanking.Security.UserTokenService.Implementation
{
